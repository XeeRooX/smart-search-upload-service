...
{
    public class XLMRobertaChunkingHuggingFaceServiceTests
    {
        private readonly IConfiguration _configuration;
        public XLMRobertaChunkingHuggingFaceServiceTests()
        {
            var inMemoryConfig = new Dictionary<string, string?>
            {
                {"ModelInfo:TokenizerPath", "..\\..\\..\\..\\..\\common\\models\\tokenizer.json" },
        ...
        {
            IChunkingService chunkService = new XLMRobertaChunkingHuggingFaceService(_configuration);
